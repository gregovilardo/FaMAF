...
/* con lo siguiente no funciona y segun todo el internet es imposible saber de esta manera
...
// El valor que toma length es de 7
// El problema es que el array de la funcion queda en la memoria estatica la
// cual desaparece cuando salimos del scope de la funcion
