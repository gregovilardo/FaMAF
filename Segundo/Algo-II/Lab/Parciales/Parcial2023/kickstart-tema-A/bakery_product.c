...
BakeryProduct bakery_product_from_file(FILE* file)
{
    ...
    int res = fscanf(file, " (%u, %u) (%u, %u) (%u, %u) %u ", &product.flour_cant, &product.flour_price, &product.yeast_cant, &product.yeast_price, &product.butter_cant, &product.butter_price, &product.sale_value);
